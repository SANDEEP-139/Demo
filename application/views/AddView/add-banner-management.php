...
<div class="container">
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto text-primary">Add Website Banner</h4>
            </div>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
                <form class="form-size" action="<?= base_url('Additems/Addbanner') ?>" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        <label class="text-primary">banner</label>
                        <input type="text" class="form-control" name="bannername" id="inputEmail" placeholder="banner name" required>
                    </div>
