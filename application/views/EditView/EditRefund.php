...
<div class="container">
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto text-primary">Edit Refund</h4>
            </div>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            <form class="form-size" action="<?php echo base_url("Edititems/Editrefund/{$dbdata['order_id']}"); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <!-- <input type="text" class="form-control" value="<?= $dbdata['order_status'] ?>" id="inputPassword" name="orderstatus" placeholder="Order Status" required> -->
                    <!-- <label class="text-primary">Order Status</label> -->
                ...
                <div class="form-group">
                    <label class="text-primary">Refund Status</label>
                    <!-- <input type="text" class="form-control" value="<= $dbdata['refund_status'] ?>" id="inputPassword" name="refundstatus" placeholder="Refund Status" required> -->
                    <!-- <label class="text-primary">Order Status</label> -->
                    <select name="refundstatus" class="form-control" value="<?= $dbdata['refund_status'] ?>" id="exampleFormControlSelect1">
                        <option>pending</option>
                        <option>shiped</option>
                        <option>delivered</option>
                        <option>return</option>
                ...
                <div class="custom-file">
                    ...
                    <td><img src="<?php echo base_url("/uploads/RefundImage/");?><?= $dbdata['image'] ?>"  alt="photo" style="border-radius:50%;" height="50px"; width="50px";/><?= $dbdata['image'] ?></td>
