...
<div class="container">
  <div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
      <div class="d-flex">
        <h4 class="content-title mb-0 my-auto">Edit Store Deal</h4>
      </div>
    </div>
  </div>
</div>
...
<div class="card">
  <div class="card-body">
    <div class="AddStoreDiv">
      <form class="AddStoreForm" action="<?php echo base_url("Edititems/Editstoredeals/{$dbdata['store_id']}"); ?>" method="post">
        ...
        <div class="form-group">
          <label for="inputEmail">Store Name</label>
          <input type="text" class="form-control" name="storename" value="<?= $dbdata['store_name'] ?>" id="inputEmail" placeholder="store name" required>
        </div>
