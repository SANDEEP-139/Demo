...
<div class="container">
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Online Deals</h4>
            </div>
        </div>
        <div class="d-flex my-xl-auto right-content">
            <div class="pr-1 mb-3 mb-xl-0">
                <a href="<?= base_url('Admin/storedeals') ?>"><button type="button" class="btn btn-info"><i class="fe fe-plus"></i>Store Deals</button></a>
            </div>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="table-action">
                                    ...
                                    <a href="" data-toggle="modal" data-target="#myModalup<?php echo $record['deal_id']; ?>" class="trigger-btn"><i class="align-middle" data-feather="edit"></i></a>
                                    <a href="#myModalBlockUser" class="trigger-btn" data-toggle="modal"><i class="align-middle" data-feather="slash"></i></a>
                                    <a href="" class="trigger-btn" data-target="#myModal<?php echo $record['deal_id']; ?>" data-toggle="modal"><i class="align-middle" data-feather="trash"></i></a>

                                </td>
                            <div id="myModal<?php echo $record['deal_id']; ?>" class="modal fade">
                                    <div class="modal-dialog modal-confirm">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer justify-content-center">
                                                ...
                                                <a href="<?php echo base_url('Deleteitems/Deleteonlinedeals/' . $record['deal_id']) ?>"><button type="button" class="btn btn-danger">Delete</button></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div id="myModalup<?php echo $record['deal_id']; ?>" class="modal fade">
                                    <div class="modal-dialog modal-confirm">
                                        <div class="modal-content">
                                            <div class="modal-header flex-column">
                                                <div class="icon-box">
                                            ...
                                            <div class="modal-footer justify-content-center">
                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                                                <a href="<?php echo base_url('Edititems/Editonlinedeals/' . $record['deal_id']) ?>">
