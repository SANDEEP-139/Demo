...
<div class="container">
	<div class="breadcrumb-header justify-content-between">
		<div class="my-auto">
			<div class="d-flex">
				<h4 class="content-title mb-0 my-auto">Invantory Management</h4>
			</div>
		</div>
						...
						<?php foreach ($records as $key => $record) : ?>
							...
							<tr>
								...
								<td><?php if (($record['product_image'])) { ?>
										<img src="<?php echo base_url("/uploads/ProductImage/" . $record['product_image']); ?>" alt="" width="120" height="70">
									<?php } else { ?>
								...
								<div class="modal-dialog modal-confirm">
									<div class="modal-content">
										...
										<div class="modal-footer justify-content-center">
											...
											<a href="<?php echo base_url('Deleteitems/Deleteinvantory/' . $record['product_id']) ?>"><button type="button" class="btn btn-danger">Delete</button></a>
										</div>
									</div>
								</div>
							</div>
							<div id="myModalup<?php echo $record['product_id']; ?>" class="modal fade">
								<div class="modal-dialog modal-confirm">
									<div class="modal-content">
										...
										<div class="modal-footer justify-content-center">
											<button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
											<a href="<?php echo base_url('Edititems/Editinvantory/' . $record['product_id']) ?>"><button type="button" class="btn btn-success">Update</button></a>
										</div>
									</div>
								</div>
							</div>
