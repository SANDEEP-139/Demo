...
<div class="container">
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">First Category Management</h4>
            </div>
        </div>
                    ...
                    <?php foreach ($records as $key => $record) : ?>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><?php if (($record['sub_cat_image'])) { ?>
                                        <img src="<?php echo base_url("/uploads/CategoryImage/" . $record['sub_cat_image']); ?>" width="120" height="70">
                                    <?php } else { ?>
                                ...
                                <td class="table-action">
                                    ...
                                    <a href="" data-toggle="modal" data-target="#myModalup<?php echo $record['sub_cat_first_id']; ?>" class="trigger-btn"><i class="align-middle" data-feather="edit"></i></a>
                                    <a href="" class="trigger-btn" data-target="#myModal<?php echo $record['sub_cat_first_id']; ?>" data-toggle="modal"><i class="align-middle" data-feather="trash"></i></a>
                                </td>
                            </tr>
                            <div id="myModal<?php echo $record['sub_cat_first_id']; ?>" class="modal fade">
                                <div class="modal-dialog modal-confirm">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer justify-content-center">
                                            ...
                                            <a href="<?php echo base_url('Deleteitems/Deletefirstcategory/' . $record['sub_cat_first_id']) ?>"><button type="button" class="btn btn-danger">Delete</button></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div id="myModalup<?php echo $record['sub_cat_first_id']; ?>" class="modal fade">
                                <div class="modal-dialog modal-confirm">
                                    <div class="modal-content">
                                        <div class="modal-header flex-column">
                                            <div class="icon-box">
                                        ...
                                        <div class="modal-footer justify-content-center">
                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                                            <a href="<?php echo base_url('Edititems/Editfirstcategory/' . $record['sub_cat_first_id']) ?>"><button type="button" class="btn btn-success">Update</button></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
