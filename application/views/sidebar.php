...
<nav id="sidebar" class="sidebar">
	<div class="sidebar-content js-simplebar">
		<a class="sidebar-brand" href="<?php echo base_url('Admin/index') ?>">
			<span class="align-middle">Marché</span>
		</a>
		...
		<?php $userInfo = $this->session->userdata('userInfo'); ?>
			...
			<?php endif;?>
			<li class="sidebar-item">
				<a class="sidebar-link" href="<?= base_url('Admin/bannerManagement') ?>">
					<i class="fas fa-percent"></i>
			...
			<?php $userInfo = $this->session->userdata('userInfo'); ?>
              <?php if(isset($userInfo[0]['store_id'])==''):?>
			<li class="sidebar-item">
				<a class="sidebar-link" href="<?= base_url('admin/notification') ?>">
