	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" method="POST" action="<?= base_url('Store/login'); ?>">
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
						<input class="input100" type="text" name="store_email" placeholder="Email">
					...
					<div class="wrap-input100 validate-input" data-validate = "Password is required">
						<input class="input100" type="password" name="store_password" placeholder="Password">
					...
					<div class="text-center p-t-12">
						...
						<a class="txt2" href="<?= base_url('Store/forgotPassword') ?>">
							Username / Password?
						</a>
